              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3">
                  {[
                    ...
                    { label: "Hon. por cobrar", tooltip: "Honorarios pendientes de cobro", value: honorarios === null ? null : Number(honorarios.saldo_por_vencer_ars || honorarios.saldo_pendiente_ars || 0), sub: honorarios && (honorarios.count_por_vencer ?? 0) > 0 ? `${honorarios.count_por_vencer} cuota${honorarios.count_por_vencer > 1 ? "s" : ""} por vencer` : undefined, color: "text-amber-600" },
                    { label: "Hon. vencidos", tooltip: "Honorarios con fecha de vencimiento pasada y sin cobrar", value: honorarios === null ? null : Number(honorarios.saldo_vencido_ars || 0), sub: honorarios && (honorarios.count_vencidos ?? 0) > 0 ? `${honorarios.count_vencidos} cuota${honorarios.count_vencidos > 1 ? "s" : ""} vencida${honorarios.count_vencidos > 1 ? "s" : ""}` : undefined, color: honorarios && (honorarios.saldo_vencido_ars || 0) > 0 ? "text-red-600" : "text-ink-400" },
