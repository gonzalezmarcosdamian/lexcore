...
const LOCALIDADES = [
  ...
  "Bahía Blanca, Buenos Aires","Tigre, Buenos Aires","Tandil, Buenos Aires",
  "Pergamino, Buenos Aires","Junín, Buenos Aires","San Nicolás, Buenos Aires",
  // Resto del país
  ...
  "Posadas, Misiones","Neuquén, Neuquén","Bariloche, Río Negro",
  "Río Gallegos, Santa Cruz","Ushuaia, Tierra del Fuego",
  "Rawson, Chubut","Comodoro Rivadavia, Chubut",
  "Viedma, Río Negro","Santa Rosa, La Pampa",
  "San Luis, San Luis","San Juan, San Juan",
  "La Rioja, La Rioja",
  "Catamarca, Catamarca",
