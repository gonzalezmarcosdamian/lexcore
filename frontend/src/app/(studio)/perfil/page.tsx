...
function PerfilPageInner() {
  ...
  const handleCheckout = async (plan: string) => {
    ...
    try {
      ...
      // Ocultar errores técnicos de MP — mostrar mensaje amigable con contacto
      setSubsMsg({ text: "No pudimos procesar el pago automáticamente. Escribinos por WhatsApp y lo resolvemos en minutos.", type: "err" });
    } finally {
