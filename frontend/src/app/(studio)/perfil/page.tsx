      ...
      >
        ...
        {subsLoading ? (
          ...
          <div className="space-y-5">
            ...
            {/* Beta — banner único. TODO(payments): reemplazar por cards de planes cuando MP esté en producción */}
            {suscripcion?.subscription_status !== "active" && (
              <div className="border border-ink-200 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-ink-50/40">
                <div>
                  <p className="text-sm font-semibold text-ink-900">¿Querés continuar después del trial?</p>
                  <p className="text-xs text-ink-500 mt-0.5">Escribinos por WhatsApp y te enviamos los planes disponibles.</p>
                </div>
                <a
                  href="https://wa.me/5492920445362?text=Hola%2C%20quiero%20conocer%20los%20planes%20de%20Luthor"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-shrink-0 flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition"
                >
