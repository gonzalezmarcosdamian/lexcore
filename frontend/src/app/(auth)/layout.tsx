      ...
      <div className="hidden lg:flex lg:w-[480px] flex-shrink-0 bg-ink-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-bold text-xl tracking-tight">Luthor</span>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="relative z-10">
          <p className="text-xs text-ink-400">© 2026 Luthor · Plataforma para estudios jurídicos</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-ink-50 min-h-screen">
        <div className="w-full max-w-sm">
          ...
          <div className="flex items-center gap-2 justify-center mb-8 lg:hidden">
            ...
            <span className="font-bold text-ink-900 text-lg">Luthor</span>
          </div>
          {children}
        </div>
      </div>
