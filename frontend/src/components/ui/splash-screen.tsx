...
const SETUP_STEPS = [
  {
    ...
    cta: "Ir a Perfil",
    href: "/perfil",
    skip: "Podés hacerlo después desde Perfil en el menú lateral.",
  },
  {
    key: "cliente",
    icon: "👤",
    ...
    cta: "Nuevo cliente",
    href: "/clientes/nuevo",
    skip: "Podés agregar clientes después desde Expedientes → Clientes.",
  },
  {
    key: "expediente",
    icon: "📁",
    title: "Creá tu primer expediente",
    desc: "Asociá un cliente y empezá a gestionar el caso.",
